...
- (void)userNameTextFieldUpdateToText:(NSString *)userName {
    [self.viewModel updateUserName:userName withCompleteBlock:^(BOOL userNameValid, BOOL loginValid) {
...
- (void)passwordTextFieldUpdateToText:(NSString *)password {
    [self.viewModel updatePassword:password withCompleteBlock:^(BOOL passwordValid, BOOL loginValid) {
